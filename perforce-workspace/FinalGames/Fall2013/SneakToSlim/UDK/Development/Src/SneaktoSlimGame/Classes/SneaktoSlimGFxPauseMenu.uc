...
function Init(optional LocalPlayer player)
{
	...
	//`log("Using Gamepad: (STSGFxPause init) " $ SneaktoSlimPawn(SneaktoSlimPlayerController(GetPC()).Pawn).getIsUsingXboxController());   // this generates a "access non pawn" warning
