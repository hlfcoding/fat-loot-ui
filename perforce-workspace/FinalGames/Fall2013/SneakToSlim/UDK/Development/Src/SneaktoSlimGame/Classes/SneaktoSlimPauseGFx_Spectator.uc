class SneaktoSlimPauseGFx_Spectator extends GFxMoviePlayer;
...
function quitIsClicked()
{
	...
	SneaktoSlimPawn_Spectator(player.Pawn).QuitCurrentGame();
}
...
function TickMap(float DeltaTime)
{
	...
	if(!SneaktoSlimPlayerController_Spectator(GetPC()).pauseMenuOn)
	{
